    ...
    <view class="content">
      ...
      <view class="s-box">
        <view class="h_box">
          ...
          <view class="right" @click="toPath('/pagesub/mine/index')"
            >我的声音&nbsp; ></view
          >
        </view>
...
const data = ref({
  ...
  num: 9,
  name: '音频-小刘',
  time: '2025-01-14 10:30:27',
  upload: {
    full_path:
      'https://ws-mars.oss-cn-beijing.aliyuncs.com/voice/2024-09-10/8dec7e19-cf2a-4043-8c8f-6adc7febbfee.MP3',
  },
  path: 'https://help-static-aliyun-doc.aliyuncs.com/file-manage-files/zh-CN/20230227/eomj/1677483215080.wav',
  remark: '备注：克隆音色训练失败（预检失败，无声音频）',
})
...
const clone = () => {
  beginCloneIndex({
    upload_id: useClone.upload_info.upload_id,
    name: useClone.upload_info.name,
  }).then((res) => {
