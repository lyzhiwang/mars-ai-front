<template>
	<view class="container content">
		...
		<view class="txtBox">
			...
			<u--textarea v-model="value1" placeholder="请输入内容" count height="450" border="none" maxlength="5000"></u--textarea>
	...
	const upLoadFile = ()=>{
		...
		uni.uploadFile({
			...
			success: async(res) => { 
				...
				setTimeout(uni.navigateTo({url: '/pagesub/mine/begin'}), 1500)
