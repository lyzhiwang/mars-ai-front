<template>
  <view class="container-box">
    ...
    <view class="c-box">
      ...
      <view class="detail-box">
        ...
        >
		  ...
		  :height="500"
            ...
            maxlength="-1"
            @change="changeText(item, index)"
          ></u--textarea>
        </view>
        <template v-if="count < 5000">
          <image
            src="/static/images/living/loading.png"
            class="loading"
            v-if="isLoading"
          ></image>
      ...
      <view class="tips">
        <view class="title" :class="{ red: count > 5000 }"
          >字数：{{ count }}/5000</view
        >
        建议5000字，如果对生成文案不满意，可点击生成的文案进行修改，或者在其他地方生成文案覆盖到这里即可。</view
      >
    </view>
